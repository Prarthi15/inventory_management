...
import '../Custom-Files/product-card.dart'; // Import the API service
...
class InventoryProvider extends ChangeNotifier {
  ...
  bool _isInFormVisible = false;
  bool get isInFormVisible => _isInFormVisible;

  void IntoggleFormVisibility() {
    _isInFormVisible = !_isInFormVisible;
    notifyListeners();
  }
