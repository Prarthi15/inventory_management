...
//mobile layout
  ...
  Padding webLayout(BuildContext context,) {
    ...
    return Padding(
      padding: MediaQuery.of(context).size.width > 900
          ? const EdgeInsets.only(top: 40.0, left:0)
                  ...
                  Row(
                    ...
                    children: [
                      Column(
                        ...
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: [
                          fieldTitle('Product Category', height:MediaQuery.of(context).size.width > 1200 &&
                                        MediaQuery.of(context).size.width < 1400?90:50),
                          ...
                          SizedBox(
                            height:102+(51.0*variationCount),
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              mainAxisAlignment: MainAxisAlignment.start,
                              children: [
                                fieldTitle('Variations', height: 50),
                              ],
                            ),
                          ),
                          const SizedBox(height: 8.0),
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    radioCheck('Variant Product Creation',
                                        (val) {
                                      setState(() {
                                        _selectedProductCategory = val!;
                                      });
                                    ...
                                    MediaQuery.of(context).size.width > 1400
                                        ...
                                        : const SizedBox(),
                                    MediaQuery.of(context).size.width > 1400
                                        ? radioCheck('Create Kit Products',
                                            (val) {
                                            setState(() {
                                              _selectedProductCategory = val!;
                                            });
  ...
  Container variantProductCreation(BuildContext context) {
    return Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              SizedBox(
                                ...
                                height:51+(51.0*variationCount),
                                child: ListView.builder(
                                  itemBuilder: (context, index) {
                                    return MediaQuery.of(context).size.width>940?Row(
                                      crossAxisAlignment:CrossAxisAlignment.center,
                                      children: [
                                        Column(
                                          crossAxisAlignment:
